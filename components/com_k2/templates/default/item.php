...
if($this->item->params->get('itemExtraFields') && count($this->item->extra_fields)){
	$item_code='';
	foreach ($this->item->extra_fields as $key => $property) {
			if($property->name =='Код товара:'){
				$item_code = $property->value;
			}
	}

}

$document->setTitle('Купить '.$this->item->title.' '.$item_code.' во Владивостоке | Компания ДальОил');
$document->setDescription('Доступная цена на '.$this->item->title.' '.$item_code.'. Оформить заказ можно на сайте или по телефону +7-914-668-99-14');
?>
	...
	*/
	...
	<div class="itemRelated">
		...
		<div>
			...
			<div id="asd" class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="groupP">
	...
	<div class="itemVideoBlock">
		<h4><?php echo JText::_('K2_MEDIA'); ?></h4>
