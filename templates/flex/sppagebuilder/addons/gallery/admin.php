	...
	array(
		...
		'attr'=>array(
			'general' => array(
				...
				'thumbs_gap'=>array(
					'type'=>'number', 
					'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_GALLERY_THUMBS_GAP'),
					'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_GALLERY_THUMBS_GAP_DESC'),
					//'std'=>10,
					'placeholder'=>JText::_('COM_SPPAGEBUILDER_ADDON_GALLERY_THUMBS_GAP_PLACEHOLDER'),
				),
