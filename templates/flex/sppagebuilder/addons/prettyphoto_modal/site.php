...
class SppagebuilderAddonPrettyphoto_modal extends SppagebuilderAddons{
	...
	public function scripts() {
		...
		return array(JURI::base(true) . '/templates/'.$app->getTemplate().'/sppagebuilder/assets/js/jquery.prettyPhoto.js');
	}

	public function stylesheets() {
		$app = JFactory::getApplication();
		return array(JURI::base(true) . '/templates/'.$app->getTemplate().'/sppagebuilder/assets/css/prettyPhoto.css');
	}
