...
if($viewData['orderable']) {
	//echo '<input type="submit" name="addtocart" class="addtocart-button add-to-cart" value="'.vmText::_( 'COM_VIRTUEMART_CART_ADD_TO' ).'" title="'.vmText::_( 'COM_VIRTUEMART_CART_ADD_TO' ).'" />';
